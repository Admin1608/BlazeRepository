...
public class LoanApprovalFeesInvalid {
	...
	public void ValidLoanApprovalFee() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("LoanApprovalFee"))).sendKeys(properties.getProperty("LoanApprovalFeesInvalid"));
