...
public class ID2NameInvalid {
	
	
	@Test
	public void ValidID2Name() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("ID2Name"))).sendKeys(properties.getProperty("ID2NameInvalid"));
	}	
