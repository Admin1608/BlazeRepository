...
public class ID1NAameInvalid {
	
	@Test
	public void ValidID1Name() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("ID1Name"))).sendKeys(properties.getProperty("ID1NameInvalid"));
	}	
