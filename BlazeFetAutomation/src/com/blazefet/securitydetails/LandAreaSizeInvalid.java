...
public class LandAreaSizeInvalid {
	

	@Test
	public void InValidLandAreaSize() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("LandAreaSize"))).sendKeys(properties.getProperty("LandAreaSizeValueInvalid"));
