...
public class ImprovementValueValid {
	
	@Test
	public void ValidImprovementValue() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("ImprovementValue"))).sendKeys(properties.getProperty("ImprovementValueValid"));
