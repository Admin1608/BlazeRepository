...
public class LandValueValid {
	
	@Test
	public void ValidLandValue() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("LandValue"))).sendKeys(properties.getProperty("LandValueValid"));
