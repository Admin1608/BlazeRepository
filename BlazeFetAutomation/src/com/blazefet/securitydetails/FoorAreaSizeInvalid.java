...
public class FoorAreaSizeInvalid {
	
	@Test
	public void InValidFoorAreaSize() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("FloorAreaSize"))).sendKeys(properties.getProperty("FloorAreaSizeValueInvalid"));
