...
public class LandAreaSizeValid {

	@Test
	public void ValidLandAreaSize() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("LandAreaSize"))).sendKeys(properties.getProperty("LandAreaSizeValue"));
