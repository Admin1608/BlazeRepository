...
public class ImprovementValueInvalid {
	
	@Test
	public void InValidImprovementValue() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("ImprovementValue"))).clear();
		driver.findElement(By.xpath(properties.getProperty("ImprovementValue"))).sendKeys(properties.getProperty("ImprovementValueInvalid"));
