...
public class LandValueInvalid {

	@Test
	public void InValidLandValue() throws Exception
	{
		...
		driver.findElement(By.xpath(properties.getProperty("LandValue"))).clear();
		driver.findElement(By.xpath(properties.getProperty("LandValue"))).sendKeys(properties.getProperty("LandValueInvalid"));
