...
@Test
public class CreditCardExisting extends CommFunc {
	...
	public void START() throws Exception
 {
        ...
        //cf.SELECTBYVALUE("ProductType", "PTValue", driver, properties);
        
        cf.CLICK("ExistingFD",driver,properties);
        cf.CLICK("ExistingFD",driver,properties);
        
        cf.INPUT("VisaCardNum", "VisaCardNumValue", driver, properties);
        cf.INPUT("ExistingLimit", "ExistingLimitValue", driver, properties);
        cf.INPUT("OutstandingBal", "OutstandingBalValue", driver, properties);
